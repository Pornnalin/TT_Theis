...
public class SoundManager : MonoBehaviour
{
    ...
    public void PlaySound(soundInGame sound)
    {
        switch (sound)
        {
            ...
            case soundInGame.slowAi_sound:
                //audioS.volume = 1f;
                audioS.PlayOneShot(slowAi);
                break;

            case soundInGame.checkPoint_sound:
                //audioS.volume = 1f;
...
public enum soundInGame
{
    ...
    powerOn_sound,woodSmash_sound,woodDes_sound,slow_sound,log_sound, rockFall_sound,turnOff_sound,slowAi_sound,checkPoint_sound
}
